...
KERNEL_DEFCONFIG := $(TARGET_KERNEL_SOURCE)/arch/arm/configs/$(TARGET_KERNEL_CONFIG)
...
KERNEL_USE_OF ?= $(shell $(PERL) -e '$$of = "n"; while (<>) { if (/CONFIG_USE_OF=y/) { $$of = "y"; break; } } print $$of;' $(KERNEL_DEFCONFIG))

ifeq "$(KERNEL_USE_OF)" "y"
DTS_FILES = $(wildcard $(TARGET_KERNEL_SOURCE)/arch/arm/boot/dts/yep_product_*.dts)
...
$(INSTALLED_BOOTIMAGE_TARGET):
	$(LOCAL_PATH)/mkbootimg --kernel $(KERNEL_OUT)/arch/arm/boot/zImage --ramdisk $(PRODUCT_OUT)/ramdisk.img \
		...
		--base 0x00000000 --pagesize 2048 --ramdisk_offset 0x02000000 --tags_offset 0x01E00000 --dt $(PRODUCT_OUT)/dt.img  --output $(PRODUCT_OUT)/boot.img
=======
LOCAL_PATH := $(call my-dir)
...
>>>>>>> 470dfed1314c7cf97248a34551cf8671c12740ab
